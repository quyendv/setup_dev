# Tutorial: https://youtu.be/CRouVhWoWMA, see more: https://fullstack.edu.vn/blog/setup-moi-truong-lap-trinh-nhanh-chong-cho-desktop-phan-2-setup-cho-windows.html
...
# Scoop không có unikey như choco (do nó là môi trường cho dev, chocolate cho user phổ thông hơn)
...
Write-Start -msg "Installing Scoop's packages"
    ...
    scoop install <# Coding #> neovim windows-terminal pwsh oh-my-posh vscode main/nvm nodejs python postman # gcc openjdk
    scoop install <# Windows #> powertoys winfetch
